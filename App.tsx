...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-drip-black text-white max-w-md mx-auto relative overflow-hidden shadow-2xl border-x border-white/5">
      ...
      {/* View Routing */}
      <main className="h-screen overflow-y-auto relative z-10">
        ...
        {view === AppState.ERROR && (
          <div className="flex flex-col items-center justify-center h-full p-8 text-center animate-slide-up">
            ...
            <button 
              onClick={handleReset}
              className="bg-white text-black font-bold px-8 py-3 rounded-full font-display"
            >
              TRY AGAIN
            </button>
          </div>
